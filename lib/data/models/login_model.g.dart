...
const UserModelSchema = CollectionSchema(
  ...
  properties: {
    r'isEmailConfirmed': PropertySchema(
      id: 0,
...
extension UserModelQueryFilter
  ...
  QueryBuilder<UserModel, UserModel, QAfterFilterCondition>
      isEmailConfirmedEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isEmailConfirmed',
        value: value,
      ));
    });
  }
...
extension UserModelQuerySortBy on QueryBuilder<UserModel, UserModel, QSortBy> {
  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByIsEmailConfirmed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEmailConfirmed', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy>
      sortByIsEmailConfirmedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEmailConfirmed', Sort.desc);
    });
  }
...
extension UserModelQuerySortThenBy
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByIsEmailConfirmed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEmailConfirmed', Sort.asc);
    });
  }
...
extension UserModelQueryWhereDistinct
  ...
  QueryBuilder<UserModel, UserModel, QDistinct> distinctByIsEmailConfirmed() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isEmailConfirmed');
    });
  }
...
extension UserModelQueryProperty
  ...
  QueryBuilder<UserModel, bool, QQueryOperations> isEmailConfirmedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isEmailConfirmed');
    });
  }
